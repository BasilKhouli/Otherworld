...
public class ReputationValueCommand extends AbstractTargetPlayerCommand {
   ...
   private final RequiredArg<ReputationGroup> reputationGroupIdArg = this.withRequiredArg(
      "reputationGroupId", "server.commands.reputation.check.value.reputationGroupId.desc", REPUTATION_GROUP_ARG_TYPE
   );
   ...
   protected void execute(
      ...
      context.sendMessage(
         Message.translation("server.modules.reputation.valueForGroup")
            .param("id", reputationGroup.getId())
